...
class TranslateController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view("admin.translate.index", compact("files", "file", "lang", 'languages'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.translations', $r)->with('message', 'Yenilənmə əməliyyatı uğurla başa çatdı.');
